...
set(Qt5Nfc_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Nfc)
    ...
    set(Qt5Nfc_PRIVATE_INCLUDE_DIRS
        "${_qt5Nfc_install_prefix}/include/QtNfc/5.14.2"
        "${_qt5Nfc_install_prefix}/include/QtNfc/5.14.2/QtNfc"
    )
    ...
    foreach(_module_dep ${_Qt5Nfc_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Nfc_FIND_VERSION_EXACT}
    ...
    _populate_Nfc_target_properties(RELEASE "libQt5Nfc.so.5.14.2" "" FALSE)
