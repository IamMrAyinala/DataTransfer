...
set(Qt53DRender_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::3DRender)
    ...
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.14.2"
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.14.2/Qt3DRender"
    )
    ...
    foreach(_module_dep ${_Qt53DRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt53DRender_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DRender PROPERTY INTERFACE_QT_PLUGIN_TYPES "sceneparsers;geometryloaders;renderplugins")
    ...
    _populate_3DRender_target_properties(RELEASE "libQt53DRender.so.5.14.2" "" FALSE)
