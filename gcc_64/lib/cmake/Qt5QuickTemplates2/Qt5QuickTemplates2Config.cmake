...
set(Qt5QuickTemplates2_VERSION_STRING 5.14.2)
...
macro(_populate_QuickTemplates2_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::QuickTemplates2 PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5QuickTemplates2.so.5"
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.14.2"
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.14.2/QtQuickTemplates2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTemplates2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5QuickTemplates2_FIND_VERSION_EXACT}
    ...
    _populate_QuickTemplates2_target_properties(RELEASE "libQt5QuickTemplates2.so.5.14.2" "" FALSE)
