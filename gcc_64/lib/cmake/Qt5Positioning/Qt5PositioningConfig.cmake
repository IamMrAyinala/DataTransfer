...
set(Qt5Positioning_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Positioning)
    ...
    set(Qt5Positioning_PRIVATE_INCLUDE_DIRS
        "${_qt5Positioning_install_prefix}/include/QtPositioning/5.14.2"
        "${_qt5Positioning_install_prefix}/include/QtPositioning/5.14.2/QtPositioning"
    )
    ...
    foreach(_module_dep ${_Qt5Positioning_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Positioning_FIND_VERSION_EXACT}
    ...
    _populate_Positioning_target_properties(RELEASE "libQt5Positioning.so.5.14.2" "" FALSE)
