...
set(Qt5RemoteObjects_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    set(Qt5RemoteObjects_PRIVATE_INCLUDE_DIRS
        "${_qt5RemoteObjects_install_prefix}/include/QtRemoteObjects/5.14.2"
        "${_qt5RemoteObjects_install_prefix}/include/QtRemoteObjects/5.14.2/QtRemoteObjects"
    )
    ...
    foreach(_module_dep ${_Qt5RemoteObjects_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5RemoteObjects_FIND_VERSION_EXACT}
    ...
    _populate_RemoteObjects_target_properties(RELEASE "libQt5RemoteObjects.so.5.14.2" "" FALSE)
