...
set(Qt5EglFsKmsSupport_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::EglFsKmsSupport)
    ...
    foreach(_module_dep ${_Qt5EglFsKmsSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5EglFsKmsSupport_FIND_VERSION_EXACT}
    ...
    _populate_EglFsKmsSupport_target_properties(RELEASE "libQt5EglFsKmsSupport.so.5.14.2" "" FALSE)
