...
set(Qt5TextToSpeech_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    set(Qt5TextToSpeech_PRIVATE_INCLUDE_DIRS
        "${_qt5TextToSpeech_install_prefix}/include/QtTextToSpeech/5.14.2"
        "${_qt5TextToSpeech_install_prefix}/include/QtTextToSpeech/5.14.2/QtTextToSpeech"
    )
    ...
    foreach(_module_dep ${_Qt5TextToSpeech_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5TextToSpeech_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::TextToSpeech PROPERTY INTERFACE_QT_ENABLED_FEATURES speechd)
    set_property(TARGET Qt5::TextToSpeech PROPERTY INTERFACE_QT_DISABLED_FEATURES )
    ...
    _populate_TextToSpeech_target_properties(RELEASE "libQt5TextToSpeech.so.5.14.2" "" FALSE)
