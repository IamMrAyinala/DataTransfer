...
set(Qt5Charts_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Charts)
    ...
    set(Qt5Charts_PRIVATE_INCLUDE_DIRS
        "${_qt5Charts_install_prefix}/include/QtCharts/5.14.2"
        "${_qt5Charts_install_prefix}/include/QtCharts/5.14.2/QtCharts"
    )
    ...
    foreach(_module_dep ${_Qt5Charts_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Charts_FIND_VERSION_EXACT}
    ...
    _populate_Charts_target_properties(RELEASE "libQt5Charts.so.5.14.2" "" FALSE)
