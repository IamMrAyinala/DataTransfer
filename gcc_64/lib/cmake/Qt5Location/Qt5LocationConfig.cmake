...
set(Qt5Location_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Location)
    ...
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/include/QtLocation/5.14.2"
        "${_qt5Location_install_prefix}/include/QtLocation/5.14.2/QtLocation"
    )
    ...
    foreach(_module_dep ${_Qt5Location_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Location_FIND_VERSION_EXACT}
    ...
    _populate_Location_target_properties(RELEASE "libQt5Location.so.5.14.2" "" FALSE)
