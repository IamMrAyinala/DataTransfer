...
set(Qt5WaylandClient_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::WaylandClient)
    ...
    set(Qt5WaylandClient_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandClient_install_prefix}/include/QtWaylandClient/5.14.2"
        "${_qt5WaylandClient_install_prefix}/include/QtWaylandClient/5.14.2/QtWaylandClient"
    )
    ...
    foreach(_module_dep ${_Qt5WaylandClient_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5WaylandClient_FIND_VERSION_EXACT}
    ...
    _populate_WaylandClient_target_properties(RELEASE "libQt5WaylandClient.so.5.14.2" "" FALSE)
