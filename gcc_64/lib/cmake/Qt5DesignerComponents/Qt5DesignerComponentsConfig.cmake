...
macro(_populate_DesignerComponents_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5DesignerComponents_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::DesignerComponents PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5DesignerComponents.so.5"
...
if (NOT TARGET Qt5::DesignerComponents)
    ...
    _populate_DesignerComponents_target_properties(RELEASE "libQt5DesignerComponents.so.5.14.2" "" FALSE)
