...
set(Qt5Scxml_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Scxml)
    ...
    set(Qt5Scxml_PRIVATE_INCLUDE_DIRS
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.14.2"
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.14.2/QtScxml"
    )
    ...
    foreach(_module_dep ${_Qt5Scxml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Scxml_FIND_VERSION_EXACT}
    ...
    _populate_Scxml_target_properties(RELEASE "libQt5Scxml.so.5.14.2" "" FALSE)
