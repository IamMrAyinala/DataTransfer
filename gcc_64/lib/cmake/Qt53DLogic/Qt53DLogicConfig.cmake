...
set(Qt53DLogic_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::3DLogic)
    ...
    set(Qt53DLogic_PRIVATE_INCLUDE_DIRS
        "${_qt53DLogic_install_prefix}/include/Qt3DLogic/5.14.2"
        "${_qt53DLogic_install_prefix}/include/Qt3DLogic/5.14.2/Qt3DLogic"
    )
    ...
    foreach(_module_dep ${_Qt53DLogic_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt53DLogic_FIND_VERSION_EXACT}
    ...
    _populate_3DLogic_target_properties(RELEASE "libQt53DLogic.so.5.14.2" "" FALSE)
