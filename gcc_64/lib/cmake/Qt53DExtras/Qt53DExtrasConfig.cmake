...
set(Qt53DExtras_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::3DExtras)
    ...
    set(Qt53DExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DExtras_install_prefix}/include/Qt3DExtras/5.14.2"
        "${_qt53DExtras_install_prefix}/include/Qt3DExtras/5.14.2/Qt3DExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt53DExtras_FIND_VERSION_EXACT}
    ...
    _populate_3DExtras_target_properties(RELEASE "libQt53DExtras.so.5.14.2" "" FALSE)
