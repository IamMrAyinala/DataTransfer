...
set(Qt5Sensors_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Sensors)
    ...
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/QtSensors/5.14.2"
        "${_qt5Sensors_install_prefix}/include/QtSensors/5.14.2/QtSensors"
    )
    ...
    foreach(_module_dep ${_Qt5Sensors_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Sensors_FIND_VERSION_EXACT}
    ...
    _populate_Sensors_target_properties(RELEASE "libQt5Sensors.so.5.14.2" "" FALSE)
