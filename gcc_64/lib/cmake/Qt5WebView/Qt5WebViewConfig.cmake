...
set(Qt5WebView_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::WebView)
    ...
    set(Qt5WebView_PRIVATE_INCLUDE_DIRS
        "${_qt5WebView_install_prefix}/include/QtWebView/5.14.2"
        "${_qt5WebView_install_prefix}/include/QtWebView/5.14.2/QtWebView"
    )
    ...
    foreach(_module_dep ${_Qt5WebView_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5WebView_FIND_VERSION_EXACT}
    ...
    _populate_WebView_target_properties(RELEASE "libQt5WebView.so.5.14.2" "" FALSE)
