...
set(Qt5Gamepad_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Gamepad)
    ...
    set(Qt5Gamepad_PRIVATE_INCLUDE_DIRS
        "${_qt5Gamepad_install_prefix}/include/QtGamepad/5.14.2"
        "${_qt5Gamepad_install_prefix}/include/QtGamepad/5.14.2/QtGamepad"
    )
    ...
    foreach(_module_dep ${_Qt5Gamepad_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Gamepad_FIND_VERSION_EXACT}
    ...
    _populate_Gamepad_target_properties(RELEASE "libQt5Gamepad.so.5.14.2" "" FALSE)
