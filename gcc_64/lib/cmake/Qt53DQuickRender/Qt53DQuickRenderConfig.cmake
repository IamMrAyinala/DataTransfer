...
set(Qt53DQuickRender_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    set(Qt53DQuickRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickRender_install_prefix}/include/Qt3DQuickRender/5.14.2"
        "${_qt53DQuickRender_install_prefix}/include/Qt3DQuickRender/5.14.2/Qt3DQuickRender"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt53DQuickRender_FIND_VERSION_EXACT}
    ...
    _populate_3DQuickRender_target_properties(RELEASE "libQt53DQuickRender.so.5.14.2" "" FALSE)
