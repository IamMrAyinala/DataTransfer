...
set(Qt5PositioningQuick_VERSION_STRING 5.14.2)
...
macro(_populate_PositioningQuick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::PositioningQuick PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5PositioningQuick.so.5"
...
if (NOT TARGET Qt5::PositioningQuick)
    ...
    set(_Qt5PositioningQuick_OWN_INCLUDE_DIRS "${_qt5PositioningQuick_install_prefix}/include/" "${_qt5PositioningQuick_install_prefix}/include/QtPositioningQuick")
    set(Qt5PositioningQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5PositioningQuick_install_prefix}/include/QtPositioningQuick/5.14.2"
        "${_qt5PositioningQuick_install_prefix}/include/QtPositioningQuick/5.14.2/QtPositioningQuick"
    )
    ...
    foreach(_module_dep ${_Qt5PositioningQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5PositioningQuick_FIND_VERSION_EXACT}
    ...
    _populate_PositioningQuick_target_properties(RELEASE "libQt5PositioningQuick.so.5.14.2" "" FALSE)
