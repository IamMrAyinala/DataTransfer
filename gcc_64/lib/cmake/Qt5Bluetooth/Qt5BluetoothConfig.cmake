...
set(Qt5Bluetooth_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.14.2"
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.14.2/QtBluetooth"
    )
    ...
    foreach(_module_dep ${_Qt5Bluetooth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Bluetooth_FIND_VERSION_EXACT}
    ...
    _populate_Bluetooth_target_properties(RELEASE "libQt5Bluetooth.so.5.14.2" "" FALSE)
