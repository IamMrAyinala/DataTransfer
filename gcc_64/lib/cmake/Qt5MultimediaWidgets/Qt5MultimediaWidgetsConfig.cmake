...
set(Qt5MultimediaWidgets_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    set(Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaWidgets_install_prefix}/include/QtMultimediaWidgets/5.14.2"
        "${_qt5MultimediaWidgets_install_prefix}/include/QtMultimediaWidgets/5.14.2/QtMultimediaWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5MultimediaWidgets_FIND_VERSION_EXACT}
    ...
    _populate_MultimediaWidgets_target_properties(RELEASE "libQt5MultimediaWidgets.so.5.14.2" "" FALSE)
