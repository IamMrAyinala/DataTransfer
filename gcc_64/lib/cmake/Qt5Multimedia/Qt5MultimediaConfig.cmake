...
set(Qt5Multimedia_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/QtMultimedia/5.14.2"
        "${_qt5Multimedia_install_prefix}/include/QtMultimedia/5.14.2/QtMultimedia"
    )
    ...
    foreach(_module_dep ${_Qt5Multimedia_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Multimedia_FIND_VERSION_EXACT}
    ...
    _populate_Multimedia_target_properties(RELEASE "libQt5Multimedia.so.5.14.2" "" FALSE)
