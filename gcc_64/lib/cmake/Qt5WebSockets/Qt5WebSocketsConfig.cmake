...
set(Qt5WebSockets_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::WebSockets)
    ...
    set(Qt5WebSockets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebSockets_install_prefix}/include/QtWebSockets/5.14.2"
        "${_qt5WebSockets_install_prefix}/include/QtWebSockets/5.14.2/QtWebSockets"
    )
    ...
    foreach(_module_dep ${_Qt5WebSockets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5WebSockets_FIND_VERSION_EXACT}
    ...
    _populate_WebSockets_target_properties(RELEASE "libQt5WebSockets.so.5.14.2" "" FALSE)
